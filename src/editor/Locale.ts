...
const resources = {
  en: {
    translation: {
      ...
      helper: "HelperLine",
      systemPropmt: "NPC behavior settings and prerequisites",
      file: "File",
      ...
      autoSave: "AutoSave",
      overwriteProjectData: "Project data will be overwritten. Are you sure?",
      help: "Help",
      noRecentData: "None...",
      nontitle: "NonTitle",
  ...
  ja: {
    translation: {
      ...
      autoSave: "自動保存",
      overwriteProjectData: "プロジェクトのデータが上書きされます。よろしいですか？",
      help: "ヘルプ",
