            ...
            <>
              <ModalHeader className='flex flex-col gap-1'>
                ...
                <div id='login_title' className='my-4 font-bold text-gray-700'>
                  <h1 className='text-center text-4xl font-bold'>{session ? t("logout") : t("login")}</h1>
                </div>
              </ModalHeader>
              <ModalBody>
                {/** Googleログイン */}
              ...
              <ModalFooter>
                <Button color='danger' variant='light' onPress={onClose} isLoading={isLoading} disabled={isLoading}>
                  キャンセル
                </Button>
              </ModalFooter>
            </>
